...
module.exports = {
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    if (!message.member.voice.channel) return client.sendTime(message.channel, "❌ | **Bu komut için aynı ses kanalında olmamız gerekiyor..**");
  ...
  SlashCommand: {
    ...
    run: async (client, interaction, args, { GuildDB }) => {
      ...
      if (
        ...
        return client.sendTime(
          interaction,
          `❌ | **bu komutu kullanmak için ${guild.me.voice.channel} içinde olmalısın.**`
        );
