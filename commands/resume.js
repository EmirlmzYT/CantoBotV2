...
module.exports = {
    name: "devam",
    description: "Müziği sürdürür",
    usage: "",
    permissions: {
        channel: ["VIEW_CHANNEL", "SEND_MESSAGES", "EMBED_LINKS"],
        member: [],
    },
    aliases: ["devam", "devam et"],
    /**
     *
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        if (player.playing) return client.sendTime(message.channel, "❌ | **Müzik zaten yeniden başlatıldı!**");
        player.pause(false);
        await message.react("✅");
    },
     ...
     */
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            if (player.playing) return client.sendTime(interaction, "❌ | **Müzik zaten yeniden başlatıldı!**");
            player.pause(false);
