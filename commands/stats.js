...
module.exports = {
    ...
    aliases: ["about", "ping", "info", "istatistikler", "i"],
    /**
     *
    ...
    run: async (client, message) => {
            ...
            embed.setTitle(`\`${client.user.username}\` İstatistikleri`)
            embed.addFields({
                name: ':ping_pong: Ping',
            ...
            {
                name: ':clock1: Çalışma Süresi',
                value: `┕\`${duration}\``,
                inline: true
            },{
                name: ':file_cabinet: Hafıza',
                value: `┕\`${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}mb\``,
                inline: true
            })

            embed.addFields({
                name: ':homes: Sunucular',
                value: `┕\`${client.guilds.cache.size}\``,
                inline: true
            },
            {
                name: ':busts_in_silhouette: Kullanıcılar',
                value: `┕\`${client.users.cache.size}\``,
                inline: true
            },{
                name: ':control_knobs: API Gecikmesi',
